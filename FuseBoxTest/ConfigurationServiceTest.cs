...
public class ConfigurationServiceTest
{
    ...
    public static IEnumerable<object[]> ConfigureShieldCases()
    {
        yield return new object[]
        {
            ...
            new List<Component>
            {
                new RCD("RCD", 25, 3, 0, new List<Component>(), false), // 2
                new RCD("RCD", 25, 5, 0, new List<Component>(), false), // 2
                new RCD("RCD", 25, 7, 0, new List<Component>(), false), // last
            }
        };
        yield return new object[]
        {
        ...
        yield return new object[]
        {
            ...
            0, 5, 13,
            new List<Component> { new RCD("RCD", 25, 3, 0, new List<Component>(), false) }  // last
        };
    }
